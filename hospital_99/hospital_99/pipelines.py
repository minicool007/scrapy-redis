...
class Hospital99Pipeline(object):
    ...
    def _conditional_insert(self, tb, item):
        ...
        tb.execute("insert into hos_99 (PROVINCE, CITY, DISTRICT, HOS_NAME,NUM) \
                    values (%s, %s, %s, %s,%s)",
        ...
        # tb.execute("insert into hos_99detail (NUM, HOSPITAL_NAME, ALIAS, POINT_LAT, POINT_LNG, ADDRESS, TEL, TYPE, RATE, LINK, IS_HOS, NATURE) \
